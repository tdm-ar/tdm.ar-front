...
import { Maincard, SecondaryCard } from "../../Card/Card";

export function Contact() {

    return (
        <section className="min-h-screen relative flex items-center flex-col justify-center md:px-[5%] px-8 py-16 md:gap-y-16 gap-y-8 border-b border-gray-500">
            <motion.h3
