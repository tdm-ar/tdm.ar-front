...
export default function Page() {
  return (
    <main className="min-h-full w-full bg-lightBlue flex justify-center items-center absolute z-40 py-8">
      <section className="h-5/6 w-5/6 bg-white md:p-16 p-8 relative">
        ...
        <p>Rellene el formulario o envíenos un correo electrónico a tdm@tdm.ar</p>
